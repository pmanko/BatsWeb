        ...
        <div class="container">
            <div class="row">
                <div id="MAJORS" class="col-md-4">
                    ...
                    <a href="/ezVideoFull.aspx?league=MA" class="btn btn-default btn-block">EZ Video</a>
<%--                       
...
<%--                    <asp:Button ID="gamesButton" runat="server" Text="Games" OnClick="gamesButton_Click" Width="200px" CssClass="btn btn-default" />
                ...
                <div id="MINORS" class="col-md-4">
                    ...
                    <a href="/ezVideoFull.aspx?league=MI" class="btn btn-default btn-block">EZ Video</a>
