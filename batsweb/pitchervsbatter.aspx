...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container main-container">
        <form id="form1" runat="server">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="list-group">
                                <div class="list-group-item">
                                    ...
                                    <asp:Button ID="goButton" runat="server" Text="Go" OnClick="goButton_Click" class="btn btn-default"/>
                                </div>
                           </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <asp:Label ID="headerLabel" runat="server" BorderStyle="Groove" Text=" Inn Batter         Out Rnrs  Res  RBI   Inn Batter         Out Rnrs  Res  RBI" Font-Bold="True" Font-Names="Consolas" Font-Size="Medium" class="form-control"></asp:Label>
                                </div>
                                <div class="row">
            ...
            <asp:Panel ID="selectPitcher" runat="server" Height="400px" style="margin-left: 0px" Width="800px">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
            ...
            <asp:Panel ID="selectBatter" runat="server" Height="400px" style="margin-left: 0px" Width="800px">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
